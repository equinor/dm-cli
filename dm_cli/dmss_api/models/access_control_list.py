...
class AccessControlList(BaseModel):
    ...
    users: Optional[Dict[str, AccessLevel]] = None
    others: Optional[AccessLevel] = None
    __properties: ClassVar[List[str]] = ["owner", "roles", "users", "others"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "owner": obj.get("owner"),
            "roles": dict((_k, _v) for _k, _v in obj.get("roles").items()) if obj.get("roles") is not None else None,
            "users": dict((_k, _v) for _k, _v in obj.get("users").items()) if obj.get("users") is not None else None,
