...
from dm_cli.dmss_api.exceptions import ApiException, ApiTypeError, ApiValueError
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = AccessControlApi()
        api_instance.get_acl  # this is an instance of the class Endpoint
        api_instance.get_acl()  # this invokes api_instance.get_acl.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_acl.callable or self.callable in this class
