...
class AccessControlList(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'owner': (str,),  # noqa: E501
            'roles': ({str: (AccessLevel,)},),  # noqa: E501
            'users': ({str: (AccessLevel,)},),  # noqa: E501
            'others': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, owner, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            roles ({str: (AccessLevel,)}): [optional] if omitted the server will use the default value of {}  # noqa: E501
            users ({str: (AccessLevel,)}): [optional] if omitted the server will use the default value of {}  # noqa: E501
            others (bool, date, datetime, dict, float, int, list, str, none_type): [optional]  # noqa: E501
        """
