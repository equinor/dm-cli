...
class Dependency(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, alias, type, protocol, address, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            version (str): [optional] if omitted the server will use the default value of ""  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, alias, type, protocol, address, *args, **kwargs):  # noqa: E501
        """Dependency - a model defined in OpenAPI
