...
# Path params
AbsolutePathSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'absolute_path': typing.Union[AbsolutePathSchema, str, ],
    }
)
...
request_path_absolute_path = api_client.PathParameter(
    name="absolute_path",
...
class BaseApi(api_client.Api):
    @typing.overload
    def _document_get_by_path_oapg(
        self,
...
class DocumentGetByPath(BaseApi):
    ...
    def document_get_by_path(
        ...
        return self._document_get_by_path_oapg(
