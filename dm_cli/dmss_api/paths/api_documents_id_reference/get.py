...
# Path params
IdReferenceSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'id_reference': typing.Union[IdReferenceSchema, str, ],
    }
)
...
request_path_id_reference = api_client.PathParameter(
    name="id_reference",
    style=api_client.ParameterStyle.SIMPLE,
    schema=IdReferenceSchema,
    required=True,
)
_auth = [
    'APIKeyHeader',
...
class DocumentGetById(BaseApi):
    ...
    def document_get_by_id(
        ...
        return self._document_get_by_id_oapg(
