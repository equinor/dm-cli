...
# Path params
AbsoluteRefSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'absolute_ref': typing.Union[AbsoluteRefSchema, str, ],
    }
)
...
request_path_absolute_ref = api_client.PathParameter(
    name="absolute_ref",
    style=api_client.ParameterStyle.SIMPLE,
    schema=AbsoluteRefSchema,
    required=True,
)
# body param
...
class DocumentAdd(BaseApi):
    ...
    def document_add(
        ...
        return self._document_add_oapg(
            body=body,
