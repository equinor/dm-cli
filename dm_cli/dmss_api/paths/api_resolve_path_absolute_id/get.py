...
# Path params
AbsoluteIdSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'absolute_id': typing.Union[AbsoluteIdSchema, str, ],
    }
)
...
request_path_absolute_id = api_client.PathParameter(
    name="absolute_id",
    style=api_client.ParameterStyle.SIMPLE,
    schema=AbsoluteIdSchema,
    required=True,
)
_auth = [
    'APIKeyHeader',
...
class BlueprintResolve(BaseApi):
    ...
    def blueprint_resolve(
        ...
        return self._blueprint_resolve_oapg(
