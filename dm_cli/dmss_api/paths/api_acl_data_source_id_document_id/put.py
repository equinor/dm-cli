...
# Query params
RecursivelySchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'recursively': typing.Union[RecursivelySchema, bool, ],
    },
    total=False
)
...
request_query_recursively = api_client.QueryParameter(
    name="recursively",
    style=api_client.ParameterStyle.FORM,
    schema=RecursivelySchema,
    explode=True,
)
# Path params
...
# body param
SchemaForRequestBodyApplicationJson = ACL


request_body_acl = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _set_acl_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_acl.serialize(body, content_type)
