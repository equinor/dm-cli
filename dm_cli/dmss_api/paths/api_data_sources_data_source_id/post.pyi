...
# body param
SchemaForRequestBodyApplicationJson = DataSourceRequest


request_body_data_source_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _data_source_save_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_data_source_request.serialize(body, content_type)
...
class DataSourceSave(BaseApi):
    ...
    def data_source_save(
        ...
        return self._data_source_save_oapg(
            body=body,
