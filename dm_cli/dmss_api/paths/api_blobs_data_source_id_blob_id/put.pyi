...
BlobIdSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'data_source_id': typing.Union[DataSourceIdSchema, str, ],
        'blob_id': typing.Union[BlobIdSchema, str, ],
    }
)
...
request_path_blob_id = api_client.PathParameter(
    name="blob_id",
    style=api_client.ParameterStyle.SIMPLE,
    schema=BlobIdSchema,
    required=True,
...
# body param
SchemaForRequestBodyMultipartFormData = BodyBlobUpload
