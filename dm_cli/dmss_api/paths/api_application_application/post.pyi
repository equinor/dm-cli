...
# Query params
RecipePackageSchema = schemas.StrSchema
RequestRequiredQueryParams = typing_extensions.TypedDict(
    'RequestRequiredQueryParams',
    {
        'recipe_package': typing.Union[RecipePackageSchema, str, ],
    }
)
...
request_query_recipe_package = api_client.QueryParameter(
    name="recipe_package",
...
class CreateLookup(BaseApi):
    ...
    def create_lookup(
        ...
        return self._create_lookup_oapg(
