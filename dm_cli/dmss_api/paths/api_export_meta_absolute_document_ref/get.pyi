...
# Path params
AbsoluteDocumentRefSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'absolute_document_ref': typing.Union[AbsoluteDocumentRefSchema, str, ],
    }
)
...
request_path_absolute_document_ref = api_client.PathParameter(
    name="absolute_document_ref",
    style=api_client.ParameterStyle.SIMPLE,
    schema=AbsoluteDocumentRefSchema,
    required=True,
)
...
class BaseApi(api_client.Api):
    ...
    def _export_meta_oapg(
        ...
        _path_params = {}
        for parameter in (
            request_path_absolute_document_ref,
        ):
