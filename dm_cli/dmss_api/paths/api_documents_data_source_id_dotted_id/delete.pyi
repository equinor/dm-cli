...
DottedIdSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'data_source_id': typing.Union[DataSourceIdSchema, str, ],
        'dotted_id': typing.Union[DottedIdSchema, str, ],
    }
)
...
request_path_dotted_id = api_client.PathParameter(
    name="dotted_id",
    style=api_client.ParameterStyle.SIMPLE,
    schema=DottedIdSchema,
    required=True,
)
...
class DocumentRemove(BaseApi):
    ...
    def document_remove(
        ...
        return self._document_remove_oapg(
