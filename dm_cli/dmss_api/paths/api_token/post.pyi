...
TimeToLiveSchema = schemas.IntSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'scope': typing.Union[ScopeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
        'time_to_live': typing.Union[TimeToLiveSchema, decimal.Decimal, int, ],
    },
    total=False
)
...
request_query_time_to_live = api_client.QueryParameter(
    name="time_to_live",
    style=api_client.ParameterStyle.FORM,
    schema=TimeToLiveSchema,
    explode=True,
)
...
class TokenCreate(BaseApi):
    ...
    def token_create(
        ...
        return self._token_create_oapg(
