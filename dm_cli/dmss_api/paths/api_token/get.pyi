...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['PATData']:
            return PATData

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['PATData'], typing.List['PATData']],
    ...
    def __getitem__(self, i: int) -> 'PATData':
...
class TokenListAll(BaseApi):
    ...
    def token_list_all(
        ...
        return self._token_list_all_oapg(
