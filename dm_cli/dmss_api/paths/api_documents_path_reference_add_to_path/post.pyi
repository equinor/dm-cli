...
from dmss_api.model.body_document_add_to_path import BodyDocumentAddToPath
from dmss_api.model.error_response import ErrorResponse

# Query params
UpdateUncontainedSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'update_uncontained': typing.Union[UpdateUncontainedSchema, bool, ],
    },
    total=False
)
...
request_query_update_uncontained = api_client.QueryParameter(
    name="update_uncontained",
    style=api_client.ParameterStyle.FORM,
    schema=UpdateUncontainedSchema,
    explode=True,
)
# Path params
PathReferenceSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'path_reference': typing.Union[PathReferenceSchema, str, ],
    }
)
...
request_path_path_reference = api_client.PathParameter(
    name="path_reference",
...
# body param
SchemaForRequestBodyMultipartFormData = BodyDocumentAddToPath
...
class BaseApi(api_client.Api):
    @typing.overload
    def _document_add_to_path_oapg(
        self,
    ...
    def _document_add_to_path_oapg(
        ...
        for parameter in (
            request_query_update_uncontained,
        ):
...
class DocumentAddToPath(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def document_add_to_path(
        self,
        content_type: typing_extensions.Literal["multipart/form-data"] = ...,
        body: typing.Union[SchemaForRequestBodyMultipartFormData, schemas.Unset] = schemas.unset,
        query_params: RequestQueryParams = frozendict.frozendict(),
    ...
    def document_add_to_path(
        ...
        return self._document_add_to_path_oapg(
            body=body,
