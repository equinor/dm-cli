...
RequestRequiredPathParams = typing_extensions.TypedDict(
    ...
    {
        'type_ref': typing.Union[TypeRefSchema, str, ],
    }
)
...
request_path_type_ref = api_client.PathParameter(
    name="type_ref",
    style=api_client.ParameterStyle.SIMPLE,
    schema=TypeRefSchema,
    required=True,
)
_auth = [
    'APIKeyHeader',
...
SchemaFor200ResponseBodyApplicationJson = GetBlueprintResponse
...
class BlueprintGet(BaseApi):
    ...
    def blueprint_get(
        ...
        return self._blueprint_get_oapg(
