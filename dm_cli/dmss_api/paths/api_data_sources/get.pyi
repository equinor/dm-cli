...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['DataSourceInformation']:
            return DataSourceInformation

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['DataSourceInformation'], typing.List['DataSourceInformation']],
    ...
    def __getitem__(self, i: int) -> 'DataSourceInformation':
...
class DataSourceGetAll(BaseApi):
    ...
    def data_source_get_all(
        ...
        return self._data_source_get_all_oapg(
