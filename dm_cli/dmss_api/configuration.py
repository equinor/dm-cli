...
AuthSettings = TypedDict(
    "AuthSettings",
    {
        "OAuth2AuthorizationCodeBearer": OAuth2AuthSetting,
...
conf = dm_cli.dmss_api.Configuration(
    ...
    def __init__(
        ...
        *,
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("dm_cli.dmss_api")
