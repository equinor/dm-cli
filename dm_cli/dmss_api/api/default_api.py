...
class DefaultApi:
    ...
    def document_add_simple_bulk(
        ...
        Add many documents 'as-is' to the data source, mainly used for bootstrapping and imports.  This is the batched equivalent of 'documents-add-raw'. Sending many documents in one request avoids paying the per-request overhead for every single document, which makes large imports considerably faster.  Args: - data_source_id (str): The ID of the data source where the documents should be added. - documents (list[dict]): The documents to add to the data source. - user (User): The authenticated user accessing the endpoint, automatically generated from provided bearer token or Access-Key.  Returns: - list[str]: IDs of the documents that were uploaded, in the same order as they were posted.
        ...
        _param = self._document_add_simple_bulk_serialize(
            data_source_id=data_source_id,
            request_body=request_body,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def document_add_simple_bulk_with_http_info(
        self,
        data_source_id: StrictStr,
        request_body: List[Optional[Dict[str, Any]]],
        _request_timeout: Union[
    ...
    @validate_call
    def document_add_simple_bulk_without_preload_content(
        self,
        data_source_id: StrictStr,
        request_body: List[Optional[Dict[str, Any]]],
        _request_timeout: Union[
    ...
    def _document_add_simple_bulk_serialize(
        self,
        data_source_id,
        request_body,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/documents-add-raw-bulk/{data_source_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def document_get(
        self,
        address: StrictStr,
        depth: Optional[Annotated[int, Field(lt=1000, strict=True, gt=-1)]] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
